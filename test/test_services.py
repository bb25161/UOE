...
@pytest.fixture
def mock_detector_anomaly(mocker):
...
@pytest.fixture
def mock_detector_no_anomaly(mocker):
...
@pytest.fixture
def mock_notification_channels(mocker):
...
def test_service_initialization_valid(mock_log_source, mock_detector_no_anomaly, mock_notification_channels):
...
def test_service_initialization_invalid_dependencies(mock_log_source, mock_detector_no_anomaly, mock_notification_channels):
...
def test_monitor_and_alert_anomaly_detected_calls_detector_and_channels(mock_log_source, mock_detector_anomaly, mock_notification_channels):
...
def test_monitor_and_alert_no_anomaly_detected_does_not_alert(mock_log_source, mock_detector_no_anomaly, mock_notification_channels):
...
def test_monitor_and_alert_skips_invalid_log_entry(mock_log_source, mock_detector_no_anomaly, mock_notification_channels, caplog):
...
def test_monitor_and_alert_handles_detector_exception_gracefully(mock_log_source, mock_detector_anomaly, mock_notification_channels, caplog):
...
def test_monitor_and_alert_handles_one_channel_failing(mock_log_source, mock_detector_anomaly, mock_notification_channels, caplog):
...
def test_monitor_handles_log_source_exception(mock_log_source, mock_detector_no_anomaly, mock_notification_channels, caplog):
